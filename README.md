# 🚀 Mi Proyecto Web - Reventa

## 📌 Lo que he aprendido hoy:
- **HTML** es la estructura (el esqueleto).
- `<head>`: Configuración invisible para el usuario.
- `<body>`: Todo el contenido visible.
- `<a>`:Permiten navegar a otra página o red social.Usan el atributo `href` para la direccion.
